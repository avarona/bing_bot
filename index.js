...
const main = async (driver, min, max) => {
  try {
    ...
    const rewardsBefore = await driver
      .findElement(By.xpath(rewardsShortPath))
      .getText();
    ...
    const rewardsAfter = await driver
      .findElement(By.xpath(rewardsShortPath))
      .getText();
    ...
    await fs.writeFile("/tmp/screenshots/err.png", image, "base64", (err) =>
      console.log(err)
    );
